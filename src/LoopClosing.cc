...
extern int iter, minInliers, maxIterations;
...
bool LoopClosing::ComputeSim3()
{
    ...
    for(int i=0; i<nInitialCandidates; i++)
    {
        ...
        else
        {
            ...
            pSolver->SetRansacParameters(0.99,minInliers,maxIterations); //20, 300
...
void LoopClosing::RunGlobalBundleAdjustment(unsigned long nLoopKF)
{
    ...
    Optimizer::GlobalBundleAdjustemnt(mpMap,iter,&mbStopGBA,nLoopKF,false);
